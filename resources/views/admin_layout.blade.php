                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span
                                class="username">{{ session()->has('admin_name') ? session('admin_name') : '' }}</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout">
                            <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                            <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                            <li><a href="{{ url('/account/logout') }}"><i class="fa fa-key"></i> Log Out</a></li>
                        </ul>
                    </li>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-book"></i>
                                <span>Danh mục nhóm sản phẩm</span>
                            </a>
                            <ul class="sub">
                                <li><a href="{{ url('/add-category-product') }}">Thêm danh mục nhóm sản phẩm</a></li>
                                <li><a href="{{ url('/all-category-product') }}">Liệt kê danh mục nhóm sản phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ url('/all-brand-product') }}">Danh mục thương hiệu sản phẩm</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ url('/all-product') }}">Danh mục sản phẩm</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
