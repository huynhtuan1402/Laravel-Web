                    ...
                    <div class="col-sm-6">
                        <div class="social-icons pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="{{ url('https://www.facebook.com/huynhtuan1417') }}" target="_blank"><i
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="{{url('/show-all-product')}}">Sản phẩm<i class=""></i></a>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="{{ asset('frontend/images') }}/dthoai-banner.png" class=""
                                    alt="" height="500px" width="1024px" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontend/images') }}/dthoai-banner2.webp" class=""
                                    alt="" height="500px" width="1024px" />
                            </div>

                            <div class="item">
                                <img src="{{ asset('frontend/images') }}/dthoai-banner3.jpg" class=""
                                    alt="" height="500px" width="1024px" />
                            </div>
                        </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="{{ url('show-product-of-category/' . $category->id) }}">
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach ($category as $category)
                                        <li><a href="{{ url('show-product-of-category/' . $category->id) }}">
                                            {{ $category->category_name }}
                                        </a></li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach ($brand as $brand)
                                        <li><a href="{{ url('show-product-of-brand/' . $brand->id) }}"> <span
